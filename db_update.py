...
from tours.models import  Trip, Guide, OurTours, Clients, FoundUs

def main():

    clientsQuery = Clients.objects.all()
    for client in clientsQuery:
        client.foundUs = get_object_or_404(FoundUs, old_letter=client.found_us)
        client.save()
